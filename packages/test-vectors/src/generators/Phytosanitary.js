...
const getPhytosanitary = () => {
    ...
    const fields = 'facility(address),notes,inspector(type,person(type,firstName,lastName)),shipment(deliveryAddress(type,*),originAddress(type,*),products(type,name,description,sizeOrAmount,weight,sku)),applicant(type,worksFor(address,name)),inspectionDate';
